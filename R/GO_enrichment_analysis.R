...
#'}
GO_enrichment_analysis <- function(gene_sets, background, organism = "org.Hs.eg.db", ont = "BP", nodeSize = 5, algorithm = "elim", statistic = "fisher", cutOff = 0.01, mergeCutOff = 0.05) {
