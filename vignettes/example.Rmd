...
## Python requirements 
The feature selection procedure is implemented with Python's scikit-learn library. The package requires an Anaconda installation to work properly. Upon first launch of the package you will be prompted if you would like to initiate the package Python working environment "GeneSelectR_env". After that you will be asked whether you would like the necessary Python packages to be installed. The Python requirements are listed in the requirements.txt file. 
