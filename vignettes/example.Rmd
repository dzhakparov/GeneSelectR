...
And then we can pass it as an arguments to fit_and_evaluate_pipelines function:
...
```
### Passing Custom sklearn Pipelines
In some cases you would want to pass a whole sklearn Pipeline objects with transformers of your choice. In this case the whole Pipeline should be passed to pipelines argument in following fashion: 
```{r}
